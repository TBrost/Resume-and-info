...
```{r}
pander(tribble(
  ~ Degree, ~ Year, ~ Institution, ~ Where, ~ Notes,
  "BS of Economics", "Sept 2020 - Dec 2024", "Brigham Young University - Idaho", "Rexburg, Idaho", "Minors in: Data Science, Statistics, Spanish" ,
